...
class Metaclass_Distance(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _distance
...
class Distance(metaclass=Metaclass_Distance):
    from interfaces.srv._distance import Distance_Request as Request
    from interfaces.srv._distance import Distance_Response as Response
